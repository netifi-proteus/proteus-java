#ifndef NET_PROTEUS_COMPILER_BLOCKING_JAVA_GENERATOR_H_
#define NET_PROTEUS_COMPILER_BLOCKING_JAVA_GENERATOR_H_
...
namespace blocking_java_proteus_generator {
...
#endif  // NET_PROTEUS_COMPILER_BLOCKING_JAVA_GENERATOR_H_
