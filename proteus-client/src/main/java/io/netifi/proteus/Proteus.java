...
public class Proteus implements Closeable {
  ...
  public ProteusSocket destination(String destination, String group) {
    return unicastServiceSocket(group, Tags.of("destination", destination));
  }

  @Deprecated
  public ProteusSocket group(String group) {
    return unicastServiceSocket(group, Tags.empty());
  }
  ...
  public ProteusSocket unicastServiceSocket(String group, Tags tags) {
    Objects.requireNonNull(group);
    Objects.requireNonNull(tags);
    return brokerService.unicast(group, tags);
  }
  ...
  public ProteusSocket unicastNamedRSocket(String name, String group, Tags tags) {
    return NamedRSocketClientWrapper.wrap(
        Objects.requireNonNull(name), unicastServiceSocket(group, tags));
  }
