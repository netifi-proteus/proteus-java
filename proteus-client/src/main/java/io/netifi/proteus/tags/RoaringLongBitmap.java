...
public class RoaringLongBitmap implements Externalizable, LongBitmapDataProvider {

  // Not final to enable initialization in Externalizable.readObject
  private NavigableMap<Integer, RoaringBitmap> highToBitmap;
  ...
  private transient Map.Entry<Integer, RoaringBitmap> latestAddedHigh = null;
   ...
   */
  public RoaringLongBitmap(boolean signedLongs) {
   ...
   */
  public RoaringLongBitmap(boolean signedLongs, boolean cacheCardinalities) {
  ...
  public RoaringBitmap getBitmap(int high) {
    return highToBitmap.get(high);
  }
  ...
  public void addLong(long x) {
    ...
    Map.Entry<Integer, RoaringBitmap> local = latestAddedHigh;
  ...
  private void pushBitmapForHigh(int high, RoaringBitmap bitmap) {
    // TODO .size is too slow
    // int nbHighBefore = highToBitmap.headMap(high).size();

    RoaringBitmap previous = highToBitmap.put(high, bitmap);
  ...
  public long getLongCardinality() {
    if (doCacheCardinalities) {
      ...
      long cardinality = 0L;
      for (RoaringBitmap bitmap : highToBitmap.values()) {
  ...
  public long select(final long j) throws IllegalArgumentException {
    ...
    if (position >= 0) {
      ...
      RoaringBitmap nextBitmap = highToBitmap.get(high);
      ...
      RoaringBitmap lowBitmap = highToBitmap.get(high);
  ...
  private long selectNoCache(long j) {
    ...
    for (Entry<Integer, RoaringBitmap> entry : highToBitmap.entrySet()) {
  ...
  public void forEach(final LongConsumer lc) {
    for (final Entry<Integer, RoaringBitmap> highEntry : highToBitmap.entrySet()) {
  ...
  public long rankLong(long id) {
    ...
    if (highPosition >= 0) {
      ...
      RoaringBitmap lowBitmap = highToBitmap.get(sortedHighs[highPosition]);
  ...
  private long rankLongNoCache(int high, int low) {
    ...
    RoaringBitmap lastBitmap = highToBitmap.get(high);
    if (lastBitmap == null) {
      // There is no value with same high: the rank is a sum of cardinalities
      for (Entry<Integer, RoaringBitmap> bitmap : highToBitmap.entrySet()) {
  ...
  protected int ensureCumulatives(int high) {
    if (allValid) {
      ...
      SortedMap<Integer, RoaringBitmap> tailMap =
      ...
      Iterator<Entry<Integer, RoaringBitmap>> it = tailMap.entrySet().iterator();
      while (it.hasNext()) {
  ...
  private void ensureOne(Map.Entry<Integer, RoaringBitmap> e, int currentHigh, int indexOk) {
   ...
   */
  public void or(final RoaringLongBitmap x2) {
    boolean firstBucket = true;

    for (Entry<Integer, RoaringBitmap> e2 : x2.highToBitmap.entrySet()) {
      // Keep object to prevent auto-boxing
      Integer high = e2.getKey();

      RoaringBitmap lowBitmap1 = this.highToBitmap.get(high);

      RoaringBitmap lowBitmap2 = e2.getValue();

      if (lowBitmap1 == null) {
        // Clone to prevent future modification of this modifying the input Bitmap
        RoaringBitmap lowBitmap2Clone = lowBitmap2.clone();

        pushBitmapForHigh(high, lowBitmap2Clone);
      } else {
        lowBitmap1.or(lowBitmap2);
      }
   ...
   * @param x2 other bitmap
   */
  public void xor(final RoaringLongBitmap x2) {
    boolean firstBucket = true;
   ...
   * @param x2 other bitmap
   */
  public void and(final RoaringLongBitmap x2) {
    boolean firstBucket = true;

    Iterator<Entry<Integer, RoaringBitmap>> thisIterator = highToBitmap.entrySet().iterator();
    while (thisIterator.hasNext()) {
      Entry<Integer, RoaringBitmap> e1 = thisIterator.next();

      // Keep object to prevent auto-boxing
      Integer high = e1.getKey();

      RoaringBitmap lowBitmap2 = x2.highToBitmap.get(high);

      if (lowBitmap2 == null) {
        // None of given high values are present in x2
        thisIterator.remove();
      } else {
        RoaringBitmap lowBitmap1 = e1.getValue();

        lowBitmap1.and(lowBitmap2);
      }
   ...
   * @param x2 other bitmap
   */
  public void andNot(final RoaringLongBitmap x2) {
    boolean firstBucket = true;
  ...
  /**
   * {@link RoaringLongBitmap} are serializable. However, contrary to RoaringBitmap, the
   ...
   * {@link RoaringLongBitmap} are subject to incompatibilities. Moreover, even on a given Java
  ...
  public LongIterator getLongIterator() {
    final Iterator<Map.Entry<Integer, RoaringBitmap>> it = highToBitmap.entrySet().iterator();

    return toIterator(it, false);
  }

  protected LongIterator toIterator(final Iterator<Map.Entry<Integer, RoaringBitmap>> it,
    ...
    return new LongIterator() {
       ...
       */
      private boolean moveToNextEntry(Iterator<Map.Entry<Integer, RoaringBitmap>> it) {
        if (it.hasNext()) {
          Map.Entry<Integer, RoaringBitmap> next = it.next();
  ...
  public boolean runOptimize() {
    ...
    for (RoaringBitmap lowBitmap : highToBitmap.values()) {
        hasChanged |= lowBitmap.runOptimize();
    }
    return hasChanged;
  }
   ...
   * @return a new bitmap
   */
  public static RoaringLongBitmap bitmapOf(final long... dat) {
    final RoaringLongBitmap ans = new RoaringLongBitmap();
    ans.add(dat);
    return ans;
  }
  ...
  public void add(final long rangeStart, final long rangeEnd) {
    ...
    for (int high = startHigh; high <= endHigh; high++) {
      ...
      if (endLowAsLong > startLowAsLong) {
        ...
        RoaringBitmap bitmap = highToBitmap.get(high);
        if (bitmap == null) {
          bitmap = new RoaringBitmap();
          pushBitmapForHigh(high, bitmap);
        }
  ...
  public boolean equals(Object obj) {
    ...
    RoaringLongBitmap other = (RoaringLongBitmap) obj;
